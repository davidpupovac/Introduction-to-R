...
```{R}
setwd('C:/Users/Korisnik.Korisnik-PC/Desktop/Lazarski/Introduction to R/third_class_data') # or whatever you want to use
```
...
myData <- read.table("C:/Users/Korisnik.Korisnik-PC/Desktop/Lazarski/Introduction to R/third_class_data/example.txt", header=TRUE, sep="\t") 
...
library(XLConnect)
myData <- readWorksheet(loadWorkbook("C:/Users/Korisnik.Korisnik-PC/Desktop/Lazarski/Introduction to R/third_class_data/example.xlsx"),sheet=1)
```
